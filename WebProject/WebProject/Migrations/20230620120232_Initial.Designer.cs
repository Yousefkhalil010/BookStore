...
namespace WebProject.Migrations
{
    ...
    [Migration("20230620120232_Initial")]
            ...
            modelBuilder.Entity("WebProject.Models.BookModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            AuthorID = 1,
                            BookPath = "~/books/Digital Design.pdf",
                            ...
                            GenreID = 1,
                            ImagePath = "~/books/pictures/digital.jpg",
                        ...
                        new
                        {
                            ID = 2,
                            AuthorID = 2,
                            BookPath = "~/books/Electronics.pdf",
                            ...
                            GenreID = 1,
                            ImagePath = "~/books/pictures/electronics.jpg",
                            Title = "Electronics"
                        },
                        new
                        {
                            ID = 3,
                            AuthorID = 3,
                            BookPath = "~/books/PIC Microcontroller and Embedded Systems.pdf",
                            ...
                            GenreID = 1,
                            ImagePath = "~/books/pictures/embdedd.jpg",
                        ...
                        new
                        {
                            ID = 4,
                            AuthorID = 4,
                            BookPath = "~/books/Beginning App development with flutter.pdf",
                            ...
                            GenreID = 1,
                            ImagePath = "~/books/pictures/flutter.jpg",
                            Title = "Flutter"
                        },
                        new
                        {
                            ID = 5,
                            AuthorID = 5,
                            BookPath = "~/books/microprocessorsandinterfacing-d-151020182302-lva1-app6892.pdf",
                            ...
                            GenreID = 1,
                            ImagePath = "~/books/pictures/microprocessor.jpg",
                        ...
                        new
                        {
                            ...
                            GenreID = 1,
                            ImagePath = "~/books/pictures/data base.jpg",
                            Title = "Database"
                        },
                        new
                        {
                            ...
                            GenreID = 2,
                            ImagePath = "~/books/pictures/book lovers.jpg",
                            Title = "Book Lovers"
                        },
                        new
                        {
                            ID = 8,
                            AuthorID = 7,
                            BookPath = "~/books/Happy Place (Emily Henry) (Books-Here).pdf",
                            ...
                            GenreID = 2,
                            ImagePath = "~/books/pictures/happy place.jpg",
                            Title = "Happy Place"
                        },
                        new
                        {
                            ID = 9,
                            AuthorID = 8,
                            BookPath = "~/books/Reminders of Him (Colleen Hoover) (books-here.com).pdf",
                            ...
                            GenreID = 2,
                            ImagePath = "~/books/pictures/reminders-of-him.jpg",
                        ...
                        new
                        {
                            ID = 10,
                            AuthorID = 9,
                            BookPath = "~/books/Twisted-Love-Ebook.pdf",
                            ...
                            GenreID = 2,
                            ImagePath = "~/books/pictures/twisted-love.jpg",
                            Title = "Twisted Love"
                        },
                        new
                        {
                            ID = 11,
                            AuthorID = 8,
                            BookPath = "~/books/PDFORALL.COM-Ugly Love by Colleen Hoover.pdf",
                            ...
                            GenreID = 2,
                            ImagePath = "~/books/pictures/ugly love.jpg",
                            Title = "Ugly Love"
                        },
                        new
                        {
                            ID = 12,
                            AuthorID = 8,
                            BookPath = "~/books/Verity-By-Colleen-Hoover.pdf",
                            ...
                            GenreID = 2,
                            ImagePath = "~/books/pictures/verity.jpg",
                            Title = "Verity"
                        },
                        new
                        {
                            ID = 13,
                            AuthorID = 10,
                            BookPath = "~/books/2000-leagues-under-the-sea.pdf",
                            ...
                            GenreID = 3,
                            ImagePath = "~/books/pictures/2000-leagues-under-the-sea.jpg",
                        ...
                        new
                        {
                            ID = 14,
                            AuthorID = 11,
                            BookPath = "~/books/adventures-of-huckleberry-finn.pdf",
                            ...
                            GenreID = 3,
                            ImagePath = "~/books/pictures/adventures-of-huckleberry-finn.jpg",
                        ...
                        new
                        {
                            ID = 15,
                            AuthorID = 12,
                            BookPath = "~/books/bronze-magic.pdf",
                            ...
                            GenreID = 3,
                            ImagePath = "~/books/pictures/bronze-magic.jpg",
                            Title = "Bronze Magic"
                        },
                        new
                        {
                            ...
                            GenreID = 3,
                            ImagePath = "~/books/pictures/fire-water.jpg",
                        ...
                        new
                        {
                            ID = 17,
                            AuthorID = 14,
                            BookPath = "~/books/in the heart of the sea.pdf",
                            ...
                            GenreID = 3,
                            ImagePath = "~/books/pictures/in the heart of the sea.jpg",
                        ...
                        new
                        {
                            ...
                            GenreID = 3,
                            ImagePath = "~/books/pictures/induction.jpg",
                            Title = "Induction"
                        });
                });
